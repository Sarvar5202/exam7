...
export default function CourseModal({ isOpen, onClose, title, subtitle, children, footer }) {
  ...
  return createPortal(
    ...
    >
      <div
        className={`bg-white h-full w-[480px] max-w-full flex flex-col shadow-2xl transition-transform duration-300 ${!isOpen ? 'translate-x-full' : 'translate-x-0'}`}
