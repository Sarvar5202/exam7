  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        {/* Desktop: collapse toggle + calendar */}
        <div className="hidden lg:flex items-center gap-2">
          <button style={{
            width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center',
            background: '#6c35de', color: '#fff', borderRadius: 8, border: 'none', cursor: 'pointer',
            fontSize: '0.8rem',
          }}>
            <ChevronIcon />
          </button>
          <button style={{
            ...
            borderRadius: 8, color: textSub, cursor: 'pointer',
          }}>
        ...
        <button style={{
          ...
          background: '#6c35de', color: '#fff', borderRadius: 10,
          padding: '7px 16px', border: 'none', cursor: 'pointer',
          fontSize: '0.82rem', fontWeight: 600,
          boxShadow: '0 2px 8px rgba(108,53,222,0.25)',
          transition: 'all 0.2s',
        }}
          onMouseOver={e => e.currentTarget.style.background = '#5d25d1'}
          onMouseOut={e => e.currentTarget.style.background = '#6c35de'}
        >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <button style={{
          ...
          <span style={{
            ...
            borderRadius: '50%', background: '#6c35de',
          }} />
        </button>
